	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			...
			<div class="col-lg-6 col-6 text-left  d-flex justify-content-end align-items-center">
				@if (Auth::check())
					<div class="dropdown">
						<!-- User avatar as circle with first letter -->
						...
						<ul class="dropdown-menu dropdown-menu-end p-3">
							...
							<li class="mb-2">{{ Auth::user()->email }}</li>
							<li><a href="{{ route('account.profile') }}" class="dropdown-item"><i class="fas fa-user-cog mr-2"></i> My Account</a></li>
							<li><a href="{{ route('account.changePassword')}}" class="dropdown-item"><i class="fas fa-lock mr-2"></i> Change Password</a></li>
							<li><a href="{{ route('account.logout') }}" class="dropdown-item text-danger"><i class="fas fa-sign-out-alt mr-2"></i> Logout</a></li>
						</ul>
					</div>
				@else
...
<style>
	.user-avatar-circle {
		...
		height: 40px;
		border-radius: 50%;
		background-color: #44668d; /* Set any background color */
		color: white;
		text-align: center;
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{ route('front.home')}}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">Artisan</span>
				<span class="h2 text-uppercase text-white px-2">Haven</span>
			</a>
